package agencyvnn.team.beautiful_girlshd.Dialog;
...
//        ImageView imgImage = (ImageView) window.findViewById(R.id.imgImage);
        ...
        btnImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                new DownLoadImageTask(mContext).execute(imagePath.get(mViewPager.getCurrentItem()));
    ...
    public static void showImageFull(final MainActivity mContext, final String imagePath,final String listIdImage, final View.OnClickListener listener){
        ...
        btnImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                new DownLoadImageTask(mContext).execute(imagePath);
                Toast toast = Toast.makeText(mContext, mContext.getString(R.string.is_setting_wallpaper), Toast.LENGTH_LONG);
                toast.show();
                //builder.dismiss();
            }
