...
public class CatelogyDetailFragment extends BaseFragment {
    ...
    private void loadMoreItemList() {
        count_page +=1;
        String category_name = mActivity.titleCatelogy;
        mService.getCategorys_Detail(category_name,count_page, AppContants.lenght_list).enqueue(new Callback<Category_Detail>() {
            @Override
