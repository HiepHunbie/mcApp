...
public class CustomListSearchAdapter extends ArrayAdapter {
    ...
    public CustomListSearchAdapter(Context context, int resource, List<String> storeDataLst) {
