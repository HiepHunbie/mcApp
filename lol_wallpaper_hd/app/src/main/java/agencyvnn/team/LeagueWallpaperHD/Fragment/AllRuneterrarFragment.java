...
public class AllRuneterrarFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_all_runeterras, container, false);
...
//        handler.postDelayed(runnable,200);
    ...
    public void loadImage(int count_page) {
        progressLoading.setVisibility(View.VISIBLE);
        mService.getCategorys(count_page,AppContants.lenght_list,10,1).enqueue(new Callback<CategoryResult>() {
            @Override
